    ...
    <>
      <div className="container mx-auto px-4 py-8 pt-30">
        ...
        <div className="max-w-5xl mx-auto text-lg leading-relaxed space-y-6">
          ...
          <p>
            Based in Pakistan, our passion for exploration knows no bounds as we
            curate personalized journeys that showcase the rich tapestry of
        ...
        {members.map((members, index) => (
          <div className="flex items-center justify-center" key={index}>
            <div className="flex p-4 flex-col items-center justify-center">
              ...
              <p className="text-gray-500 text-center">{members.position}</p>
      ...
      <div className="w-[90%] mx-auto">
        <Accordion type="single" collapsible className="w-full">
          <AccordionItem value="item-1">
            ...
            <AccordionContent>
              Booking with Voyager is simple! Browse our available tours on our
              website, select your preferred destination and dates, and follow
              the booking process. You can also contact our customer service
              team directly by phone or email if you need assistance or want to
              create a custom itinerary. We recommend booking at least 3 months
              in advance for popular destinations during peak season.
            </AccordionContent>
          </AccordionItem>
          ...
          <AccordionItem value="item-2">
            ...
            <AccordionContent>
              ...
              sustainable tourism practices and immersive cultural experiences.
              Our team includes local experts in each destination, ensuring you
              get insider access to hidden gems. We also offer 24/7 support
              during your journey and personalize each itinerary to match your
          ...
          <AccordionItem value="item-3">
            ...
            <AccordionContent>
              ...
              special discounts ranging from 10-15% depending on the destination
              and season. For custom packages, our travel specialists will work
              with you to design a personalized itinerary that matches your
              interests, timeline, and budget. We can accommodate special
              requests like anniversary celebrations, family reunions, or
              corporate retreats with tailored experiences and exclusive access
              to unique venues.
            </AccordionContent>
          </AccordionItem>
        </Accordion>
